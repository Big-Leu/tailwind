...
export default function Home() {
  return (
    <div className="w-[1920px] h-[1080px] bg-stone-900 flex flex-row justify-start items-start">
      ...
      <div className="w-[450px] h-[1080px] bg-stone-900">
        ...
        <div className="w-[105px] h-[63.16px] left-[159px] top-40 absolute text-white text-4xl  font-dangrek">Sign in</div>
      ...
      <div className="w-[1366px] h-[1080px] bg-stone-950 text-center">
        ...
        <div className="w-[93px] h-6 left-[1500px] top-[800px] absolute text-stone-400 text-[26px] font-normal font-dangrek">v1.0.1</div>
      </div>
    </div>
  )
}