...
export default function Home() {
  return (
    <div className="w-[1920px] h-[1080px] bg-stone-900 flex flex-row justify-start items-start">
      ...
      <div className="w-[460px] h-[1080px] bg-stone-900 flex flex-col space-y-10 ">
        ...
        <div className="flex justify-center gap-3">
          <button className="w-[114px] bg-emerald-400 hover:bg-emerald-500 text-white font-normal font-dangrek py-2 px-4 rounded">
          Login
          </button>
          <button className="w-[114px] bg-emerald-400 hover:bg-emerald-500 text-white font-bold py-2 px-4 rounded">
           Sign up
          </button>
        </div>
        <div className="flex justify-center">
      ...
      <div className="w-[1400px] h-[1080px] bg-stone-950 text-center">
