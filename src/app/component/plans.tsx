...
const PP: NextPage<WelcomeProps> = (props) => {
  ...
  return (
    <div className=" static max-w-[500px] bg-inherit flex justify-center pt-32">
      ...
      <div className=" relative min-w-full min-h-[600px] z-20 hover:shadow-md rounded-2xl bg-stone-900 overflow-visible ">
        ...
        <div className="w-full h-full relative top-[7rem] flex flex-col mt-[-4.4rem] space-y-3 px-5 ml-10">
