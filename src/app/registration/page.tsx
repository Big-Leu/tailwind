...
const Registration: NextPage= () => {
    ...
    return (
        <div className="w-full h-full bg-transparent flex flex-row justify-start items-start ">
          <div className="static w-[36%] min-h-[1400px] bg-stone-900">
          ...
          <div className="relative-container w-[64%] min-h-screen max-h-full bg-stone-950 ">
            <form className="w-auto px-10 py-10 min-h-full">
              ...
              <div className="relative mt-[6rem] px-10">
                <button className=" relative  w-full h-[60px] bg-emerald-400 hover:bg-emerald-600 text-white font-normal text-[30px] font-dangrek py-2 px-4 rounded">
                    next
                </button>
              </div>
            </form>
